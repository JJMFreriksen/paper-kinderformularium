...
To be able to process docx files you need to create a folder named 'data' under the project folder. Then you should put the docx files to be processed under data folder. Scripts will create a csv folder and under that csv folder. You can find the corresponding csv outputs under the csv folder.
...
*  Running Jupyter notebook
  *  For all Operating Systems:
      ...
      ```
  *  TIP:
    *  If you are new to the Jupyter Notebook you can learn the basics from this link:
